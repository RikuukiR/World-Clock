...
// $sydney = searchCityTime('シドニー');
// $shanghai = searchCityTime('上海');
// $moscow = searchCityTime('モスクワ');
// $london = searchCityTime('ロンドン');
// $Johannesburg = searchCityTime('ヨハネスブルグ');
// $new_york = searchCityTime('ニューヨーク');
